...
public class Prog3 {
	public static void main(String[] args){
		...
		//separate into individual records by the Delimiter :
		String[] splitedRecords = records.split(":");
		
		//for each record,first split by the delimiter comma and get the productId and print it.
		String nextRecordStr = null;
		String[] nextRecordArray = null;
		for(int i = 0; i < splitedRecords.length; ++i){
			nextRecordStr = splitedRecords[i];
